...
class TrialBalancesControllerTest < ActionController::TestCase
  ...
  test "should create trial_balance" do
    assert_difference('TrialBalance.count') do
      post :create, trial_balance: { hour_price: @trial_balance.hour_price, month: @trial_balance.month, total: @trial_balance.total, worked_hours: @trial_balance.worked_hours, year: @trial_balance.year }
    end
